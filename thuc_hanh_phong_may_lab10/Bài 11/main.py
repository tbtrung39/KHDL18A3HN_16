...
print("Thập lục phân:", doicoso1.thap_phan_sang_thap_luc_phan(n))

print("Chuyển từ hệ khác sang hệ thập phân")
s = input("Nhập chuỗi số (có thể là hệ 2, 8 hoặc 16): ")

if doicoso2.la_he_2(s):
    print("Hệ 2 → Thập phân:", doicoso2.co_so_2_sang_10(s))
elif doicoso2.la_he_8(s):
    print("Hệ 8 → Thập phân:", doicoso2.co_so_8_sang_10(s))
elif doicoso2.la_he_16(s):
    print("Hệ 16 → Thập phân:", doicoso2.co_so_16_sang_10(s))
else:
