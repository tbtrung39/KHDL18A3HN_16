...
tong_cac_pt = sum(a)
print('tổng các phần tử trong a là:', tong_cac_pt)
#2
...
vi_tri_lon_nhat_cuoi = len(a) - 1 - a[::-1].index(gia_tri_lon_nhat)
print('Phần tử lớn nhất:', gia_tri_lon_nhat)
print('Vị trí phần tử lớn nhất cuối cùng:', vi_tri_lon_nhat_cuoi)