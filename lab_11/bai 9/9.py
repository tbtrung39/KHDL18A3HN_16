...
def main():
    hanh_ly = doc_du_lieu("Lab_11\Bài 9\passenger.in")
    tong_trong_luong = tinh_toan_trong_luong(hanh_ly)
    ghi_file_weight(tong_trong_luong, "Lab_11\Bài 9\WEIGHT.OUT")
    ghi_file_canceled(hanh_ly, tong_trong_luong, "Lab_11\Bài 9\CANCELED.OUT")
